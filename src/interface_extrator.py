...
import os
import json
import webbrowser  # <--- NOVA IMPORTAÇÃO NECESSÁRIA
...
class AppExtrator(ctk.CTk):
    def __init__(self):
        ...
        self.title("ExtratorCB - Automação RH") # Usei um dos nomes curtos aqui
    ...
    def criar_widgets(self):
        ...
        # Ajuste de peso: Log expande, mas deixamos espaço pro rodapé
        self.grid_rowconfigure(3, weight=1) 

        # --- Bloco 1: Lista de Funcionários ---
        self.frame_txt = ctk.CTkFrame(self)
        self.frame_txt.grid(row=0, column=0, padx=20, pady=(15, 5), sticky="ew")
        ...
        self.frame_pdf.grid(row=1, column=0, padx=20, pady=5, sticky="nsew")
        ...
        self.scroll_pdfs = ctk.CTkScrollableFrame(self.frame_pdf, height=120, label_text="Arquivos na Fila")
        ...
        btn_clear_pdf = ctk.CTkButton(frame_pdf_btns, text="Limpar Lista", command=self.limpar_pdfs, 
        ...
        self.frame_out.grid(row=2, column=0, padx=20, pady=5, sticky="ew")
        ...
        self.frame_run.grid(row=3, column=0, padx=20, pady=(10, 5), sticky="nsew") # Reduzi padding inferior
        ...
        self.frame_footer.grid(row=4, column=0, sticky="ew", pady=(0, 10))
        
        # Texto clicável
        self.lbl_creditos = ctk.CTkLabel(self.frame_footer, 
                                         text="Desenvolvido por Robert Taylor 🚀", 
                                         font=ctk.CTkFont(size=11),
                                         text_color="gray60", # Cor inicial discreta
                                         cursor="hand2") # Transforma o cursor em mãozinha
        self.lbl_creditos.pack(anchor="center")
        
        # Eventos (Bind)
        self.lbl_creditos.bind("<Button-1>", lambda e: self.abrir_github())
        self.lbl_creditos.bind("<Enter>", lambda e: self.lbl_creditos.configure(text_color="#3B8ED0")) # Fica azul no hover
        self.lbl_creditos.bind("<Leave>", lambda e: self.lbl_creditos.configure(text_color="gray60"))  # Volta pra cinza
    ...
    def atualizar_lista_visual_pdfs(self):
        ...
        for i, pdf in enumerate(self.lista_pdfs):
            ...
            item_frame = ctk.CTkFrame(self.scroll_pdfs, fg_color=("gray85", "gray25")) 
